...
<template>
  <div class="sidebar-wrapper">
    ...
    <div class="logo-container" :class="{ 'collapsed': isCollapse }">
      <div class="logo">
        <img src="/logo.svg" alt="Logo" class="logo-image" v-if="!isCollapse" />
        <img src="/logo-mini.svg" alt="Logo" class="logo-mini" v-else />
      </div>
      <h1 class="logo-text" v-if="!isCollapse">管理系统</h1>
    </div>
